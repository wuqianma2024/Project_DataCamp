...
if select1=='No' and select2=='No' and select3=='No':
    st.write('Sorry None of these functions interest you. Maybe you prefer to see the [Shortest path and time](https://jinjinb-datacamp-project-8cdse1.streamlitapp.com)')
